	...
	public static void eventHandler(RenderGameOverlayEvent.Pre event) {
		if (event.getType() == RenderGameOverlayEvent.ElementType.ALL) {
			...
			if (SkillsOverlayDisplayOverlayIngameProcedure.execute(entity)) {
				...
				Minecraft.getInstance().gui.blit(event.getMatrixStack(), posX + -212, posY + 104, 0, 0, 104, 15, 104, 15);

				RenderSystem.setShaderTexture(0, new ResourceLocation("sikunbenssololeveling:textures/screens/emptybaruniversal.png"));
				Minecraft.getInstance().gui.blit(event.getMatrixStack(), posX + -212, posY + 90, 0, 0, 104, 15, 104, 15);
				...
				if (StaminaBar1Procedure.execute(entity)) {
					...
					Minecraft.getInstance().gui.blit(event.getMatrixStack(), posX + -211, posY + 92, 0, 0, 10, 11, 10, 11);
				}
				if (Stmpb2Procedure.execute(entity)) {
					...
					Minecraft.getInstance().gui.blit(event.getMatrixStack(), posX + -211, posY + 92, 0, 0, 20, 11, 20, 11);
				}
				if (Stmb3Procedure.execute(entity)) {
					...
					Minecraft.getInstance().gui.blit(event.getMatrixStack(), posX + -211, posY + 92, 0, 0, 30, 11, 30, 11);
				}
				if (Stmb4Procedure.execute(entity)) {
					...
					Minecraft.getInstance().gui.blit(event.getMatrixStack(), posX + -211, posY + 92, 0, 0, 40, 11, 40, 11);
				}
				if (Stmbar5Procedure.execute(entity)) {
					...
					Minecraft.getInstance().gui.blit(event.getMatrixStack(), posX + -211, posY + 92, 0, 0, 51, 11, 51, 11);
				}
				if (Stmpbar6Procedure.execute(entity)) {
					...
					Minecraft.getInstance().gui.blit(event.getMatrixStack(), posX + -211, posY + 92, 0, 0, 60, 11, 60, 11);
				}
				if (Stmbar7Procedure.execute(entity)) {
					...
					Minecraft.getInstance().gui.blit(event.getMatrixStack(), posX + -211, posY + 92, 0, 0, 70, 11, 70, 11);
				}
				if (Stmbar8Procedure.execute(entity)) {
					...
					Minecraft.getInstance().gui.blit(event.getMatrixStack(), posX + -211, posY + 92, 0, 0, 80, 11, 80, 11);
				}
				if (Stmbar9Procedure.execute(entity)) {
					...
					Minecraft.getInstance().gui.blit(event.getMatrixStack(), posX + -211, posY + 92, 0, 0, 90, 11, 90, 11);
				}
				if (Stmbar10Procedure.execute(entity)) {
					...
					Minecraft.getInstance().gui.blit(event.getMatrixStack(), posX + -211, posY + 92, 0, 0, 102, 11, 102, 11);
				}
				...
				if (FatiguereturnbackbarProcedure.execute(world)) {
					RenderSystem.setShaderTexture(0, new ResourceLocation("sikunbenssololeveling:textures/screens/emptybaruniversal.png"));
					Minecraft.getInstance().gui.blit(event.getMatrixStack(), posX + -212, posY + 83, 0, 0, 52, 7, 52, 7);
				}
				if (FatigueBarProcedure.execute(world, entity)) {
					...
					Minecraft.getInstance().gui.blit(event.getMatrixStack(), posX + -212, posY + 84, 0, 0, 5, 5, 5, 5);
				}
				if (Fatigue2Procedure.execute(world, entity)) {
					...
					Minecraft.getInstance().gui.blit(event.getMatrixStack(), posX + -212, posY + 84, 0, 0, 10, 5, 10, 5);
				}
				if (Fatigue3Procedure.execute(world, entity)) {
					...
					Minecraft.getInstance().gui.blit(event.getMatrixStack(), posX + -211, posY + 84, 0, 0, 15, 5, 15, 5);
				}
				if (Fatigue4Procedure.execute(world, entity)) {
					...
					Minecraft.getInstance().gui.blit(event.getMatrixStack(), posX + -212, posY + 84, 0, 0, 20, 5, 20, 5);
				}
				if (Fatigue5Procedure.execute(world, entity)) {
					...
					Minecraft.getInstance().gui.blit(event.getMatrixStack(), posX + -212, posY + 84, 0, 0, 25, 5, 25, 5);
				}
				if (Fatigue6Procedure.execute(world, entity)) {
					...
					Minecraft.getInstance().gui.blit(event.getMatrixStack(), posX + -212, posY + 84, 0, 0, 30, 5, 30, 5);
				}
				if (Fatigue7Procedure.execute(world, entity)) {
					...
					Minecraft.getInstance().gui.blit(event.getMatrixStack(), posX + -212, posY + 84, 0, 0, 35, 5, 35, 5);
				}
				if (Fatigue8Procedure.execute(world, entity)) {
					...
					Minecraft.getInstance().gui.blit(event.getMatrixStack(), posX + -212, posY + 84, 0, 0, 40, 5, 40, 5);
				}
				if (Fatigue9Procedure.execute(world, entity)) {
					...
					Minecraft.getInstance().gui.blit(event.getMatrixStack(), posX + -212, posY + 84, 0, 0, 45, 5, 45, 5);
				}
				if (FatiguemaxProcedure.execute(world, entity)) {
					...
					Minecraft.getInstance().gui.blit(event.getMatrixStack(), posX + -211, posY + 84, 0, 0, 51, 5, 51, 5);
				}
				if (FatiguereturnbackbarProcedure.execute(world)) {
				...
				Minecraft.getInstance().font
						.draw(event.getMatrixStack(),
								"Job: " + ((entity.getCapability(SikunbenssololevelingModVariables.PLAYER_VARIABLES_CAPABILITY, null)
										.orElse(new SikunbenssololevelingModVariables.PlayerVariables())).Job) + "",
								posX + -178, posY + -97, -16777216);
				Minecraft.getInstance().font.draw(event.getMatrixStack(),
						"Job: " + ((entity.getCapability(SikunbenssololevelingModVariables.PLAYER_VARIABLES_CAPABILITY, null)
								.orElse(new SikunbenssololevelingModVariables.PlayerVariables())).Job) + "",
						posX + -179, posY + -98, -1);
